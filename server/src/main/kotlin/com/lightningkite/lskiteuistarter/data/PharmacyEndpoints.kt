...
object PharmacyEndpoints : ServerBuilder() {
    ...
    suspend fun permissions(auth: AuthAccess<User>): ModelPermissions<Pharmacy> {
...
val Pharmacy.Companion.info get() = PharmacyEndpoints.info
