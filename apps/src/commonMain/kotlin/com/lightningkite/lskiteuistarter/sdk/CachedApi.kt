...
open class CachedApi(val uncached: Api) {
	...
	open val systemChatConversations = ModelCache(uncached.supportChat.conversations, com.lightningkite.lightningserver.ai.SystemChatConversation.serializer())
	open val systemChatMessages = ModelCache(uncached.supportChat.messages, com.lightningkite.lightningserver.ai.SystemChatMessage.serializer())
}
