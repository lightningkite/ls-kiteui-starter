...
class LiveApi(val fetcher: Fetcher) : Api {
	...
	inner class LiveUserAuthApi : Api.UserAuthApi, com.lightningkite.lightningserver.sessions.proofs.AuthClientEndpoints<com.heroscript.User, com.heroscript.User.ID> by com.lightningkite.lightningserver.sessions.proofs.LiveAuthClientEndpoints(fetcher, "auth/session", com.heroscript.User.serializer(), com.heroscript.User.ID.serializer()), com.lightningkite.lightningserver.typed.ClientModelRestEndpoints<com.lightningkite.lightningserver.sessions.Session<com.heroscript.User, com.heroscript.User.ID>, kotlin.uuid.Uuid> by com.lightningkite.lightningserver.typed.LiveClientModelRestEndpoints(fetcher, "auth/session/sessions", com.lightningkite.lightningserver.sessions.Session.serializer(com.heroscript.User.serializer(), com.heroscript.User.ID.serializer()), kotlin.uuid.Uuid.serializer()) {
